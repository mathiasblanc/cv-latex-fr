...
{Evooq SA} % Organization
{Lausanne} % Location
{Novembre 2021 - maintenant} % Date(s)
...
\cventry
{développeur applications sae} % Job title
{ECA Vaud} % Organization
{Pully} % Location
{Juin 2018 - Octobre 2021} % Date(s)
{ % Description(s) of tasks/responsibilities
\begin{cvitems}
...
{Renens} % Location
{Janvier 2013 - Janvier 2014} % Date(s)
{ % Description(s) of tasks/responsibilities
\begin{cvitems}
